...
This rubric is the admission checklist for tasks in the mentat eval corpus.
The goal is to measure whether an agent produces work a real mentat user would
