...
let%expect_test "a numbered choice selects first and resolves only on Enter" =
  ...
  [%expect
    ...
    03 |  █ █ █▄▄ █ █  █  █▀█  █  ▂▄▆▄▂  /tmp/mentat-tui-questiob2710150.home/mentat-tu…
    04 |
...
let%expect_test
  ...
  [%expect
    ...
    01 |
    02 |  █▄█ ██▀ █▀▄ ▀█▀ ▄▀█ ▀█▀   ·    dev · openai/gpt-5.5 medium
    03 |  █ █ █▄▄ █ █  █  █▀█  █  ▂▄▆▄▂  /tmp/mentat-tui-question-tool-cont97af4afe.hom…
    04 |
...
let%expect_test
  ...
  [%expect
    ...
    01 |
    02 |  █▄█ ██▀ █▀▄ ▀█▀ ▄▀█ ▀█▀   ·    dev · openai/gpt-5.5 medium
    03 |  █ █ █▄▄ █ █  █  █▀█  █  ▂▄▆▄▂  /tmp/mentat-tui-questiof41f17c6.home/mentat-tu…
    04 |
    05 | ❯ choose safely
    06 |
    07 | ⋯ Waiting for your answer
...
let%expect_test
  ...
  [%expect
    ...
    01 |
    02 |  █▄█ ██▀ █▀▄ ▀█▀ ▄▀█ ▀█▀   ·    dev · openai/gpt-5.5 medium
    03 |  █ █ █▄▄ █ █  █  █▀█  █  ▂▄▆▄▂  /tmp/mentat-tui-question-inli991f7729.home/men…
    04 |
    05 | ❯ choose safely
    06 |
    07 | ⋯ Waiting for your answer
...
let%expect_test "answering a question preserves the visible prompt draft" =
  ...
  [%expect
    ...
    01 |
    02 |  █▄█ ██▀ █▀▄ ▀█▀ ▄▀█ ▀█▀   ·    dev · openai/gpt-5.5 medium
    03 |  █ █ █▄▄ █ █  █  █▀█  █  ▂▄▆▄▂  /tmp/mentat-tui-questia37b86d1.home/mentat-tui…
    04 |
    05 | ❯ ask with draft
    06 |
    07 | ⋯ Waiting for your answer
...
let%expect_test "custom answers stay out of visible prompt history" =
  ...
  [%expect
    ...
    01 |
    02 |  █▄█ ██▀ █▀▄ ▀█▀ ▄▀█ ▀█▀   ·    dev · openai/gpt-5.5 medium
    03 |  █ █ █▄▄ █ █  █  █▀█  █  ▂▄▆▄▂  /tmp/mentat-tui-question1e584b8a.home/mentat-t…
    04 |
    05 | ❯ history question
    06 |
    07 | ⠋ Working… (0s · esc to interrupt)
