...
CAMLprim value mentat_file_watcher_inotify_supported(value unit) {
  (void)unit;
  return Val_true;
}

CAMLprim value mentat_file_watcher_inotify_create(value unit) {
  CAMLparam1(unit);
  CAMLlocal1(result);
...
CAMLprim value mentat_file_watcher_inotify_add_watch(value fd, value path) {
  CAMLparam2(fd, path);
...
CAMLprim value mentat_file_watcher_inotify_rm_watch(value fd, value watch) {
  CAMLparam2(fd, watch);
...
CAMLprim value mentat_file_watcher_inotify_wake(value fd) {
  CAMLparam1(fd);
...
CAMLprim value mentat_file_watcher_inotify_read(value fd, value wake_fd) {
