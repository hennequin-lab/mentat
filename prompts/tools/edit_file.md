...
- By default old_string must occur exactly once. If the edit fails
  ...
  old_string with surrounding lines until unique or pass occurrence=all to
  replace every instance. When the selected editor family provides
  apply_patch, use it for a broader structural or multi-file edit.
