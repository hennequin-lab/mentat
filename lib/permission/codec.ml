...
(* Shared codec and stable-text machinery for the structural enums owned by
   ...
   Library-private: [mentat_permission.ml] does not re-export this module, so it
   never reaches the public API. It depends only on [Import] and [Jsont],
   keeping a clean nominal DAG below [access.ml].
